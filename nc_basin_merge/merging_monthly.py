...
# output folders 
output_folder    = '/projects/0/dfguu/users/edwin/05min_runs_november_2015_merged/pcrglobwb_modflow_from_1901/1901_to_2010/'
...
complete_output_folder = output_folder + "/"                            # optional + str(year_int[0]) + "_to_" + str(last_year)
